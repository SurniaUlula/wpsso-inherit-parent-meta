...
WPSSO Core add-on to inherit parent (grand-parent, etc.) featured and custom images for posts, pages, custom post types, categories, tags, and custom taxonomies.
