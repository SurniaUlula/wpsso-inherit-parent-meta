 ...
 * Description: WPSSO Core add-on to inherit parent (grand-parent, etc.) featured and custom images for posts, pages, custom post types, categories, tags, and custom taxonomies.
 * Requires PHP: 5.4
	...
	class WpssoIpm {
		...
		private function min_version_notice() {
			...
			$error_msg = sprintf( __( 'The %1$s version %2$s add-on requires %3$s version %4$s or newer (version %5$s is currently installed).',
				'wpsso-inherit-parent-meta' ), $info['name'], $info['version'], $info['req']['short'], $info['req']['min_version'], $have_version );
